...
`${GOPATH}/src/github.com/haringattu/lsbeat`
...
```
git remote set-url origin https://github.com/haringattu/lsbeat
...
```
mkdir -p ${GOPATH}/src/github.com/haringattu/lsbeat
git clone https://github.com/haringattu/lsbeat ${GOPATH}/src/github.com/haringattu/lsbeat
```
